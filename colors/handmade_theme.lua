...
-- SYNTAX
vim.api.nvim_set_hl(0, "Normal",              {fg = colors.handmade_beige, bg = colors.handmade_dark_gray})
vim.api.nvim_set_hl(0, "NormalFloat",         {fg = colors.handmade_beige, bg = colors.handmade_dark_gray})
...
-- CURSOR
vim.api.nvim_set_hl(0, "Cursor",              {fg = colors.handmade_light_green});
